...
The function `tmax` takes the argument `stationid` in the form of six digits, reads in the corresponding file, and cleans it.
...
tmax <- function(stationid){
  ...
  station <- paste("ushcn.v2.5.5.20170118/USH00", stationid, ".raw.tmax", sep="")
  # read in the file
